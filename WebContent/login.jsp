...
<div class="row">
 <div style="width: 200px; margin: 100px auto 0 auto;"> 
	 ...
	 <div class="col-md-16" class = "form-group">
            <label for ="myname"></label><input name="username" type="text" placeholder="Username" required class="form-control"/><br>
            <label for ="mypasscode"></label><input name="userpwd" type="password" placeholder="Password" required class="form-control"/><br>
